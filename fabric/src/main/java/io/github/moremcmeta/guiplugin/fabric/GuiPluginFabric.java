...
package io.github.moremcmeta.guiplugin.fabric;
...
/**
 * Implementation of the GUI plugin on Fabric.
 * @author soir20
 */
@SuppressWarnings("unused")
public final class GuiPluginFabric implements MoreMcmetaTexturePlugin {
    @Override
